                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="field-url" name="url" placeholder="Masukan URL Video (Youtube)" value="{{ $data->url }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="field-judul" name="judul" placeholder="Masukan Judul Video" value="{{ $data->judul }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control" id="field-deskripsi" name="deskripsi" placeholder="Masukan Deskripsi Video" rows="8">{!! $data->deskripsi !!}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <label class="css-control css-control-primary css-radio">
                                    <input type="radio" class="css-control-input" id="status_publikasi" name="status" value="1" {{ $data->status === 1 ? 'checked' : '' }}>
                                    <span class="css-control-indicator"></span> Publikasikan
                                </label>
                                <label class="css-control css-control-secondary css-radio">
                                    <input type="radio" class="css-control-input" id="status_draft" name="status" value="0" {{ $data->status === 0 ? 'checked' : '' }}>
                        ...
                        <div class="row gutters-tiny items-push">
                            ...
                            <div class="col-lg-12">
                                <div class="text-center">
                                    <img id="img_preview" src="{{ asset($data->thumbnail_url) }}" width="100%">
                                </div>
