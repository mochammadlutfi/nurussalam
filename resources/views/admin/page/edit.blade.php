                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="field-judul" name="judul" placeholder="Masukan Judul" value="{{ $page->judul }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control" id="field-deskripsi" name="deskripsi" placeholder="Masukan Deskripsi Event" rows="8">{{ $page->deskripsi }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="seo_keyword" name="seo_keyword" placeholder="Masukan SEO Keyword" value="{{ $page->seo_keyword }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="seo_tags" name="seo_tags" placeholder="Masukan SEO Tags" value="{{ $page->seo_tags }}">
                                        <div class="form-text text-muted font-size-sm text-right">Gunakan tanda koma "," sebagai pemisah!</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control" id="deskripsi_seo" name="seo_deskripsi" maxlength="115" data-always-show="true" data-placement="top" placeholder="Masukan SEO Deskripsi" rows="2">{{ $page->seo_deskripsi }}</textarea>
                                ...
                                <div class="row gutters-tiny items-push">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="text-center mb-15">
                                            <img id="img_preview" src="{{ asset(empty($page->featured_img) ? "assets/img/poster.png" : $page->featured_img) }}" width="100%">
                                        </div>
